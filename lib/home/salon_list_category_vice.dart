...
import 'package:hair/salonlistdetails/salon_details.dart';
import 'package:hair/home/service_selection.dart';
import 'package:shimmer/shimmer.dart';

class SalonListCategory extends StatefulWidget
{

  String seattype,servicetype,category;


  SalonListCategory(this.seattype, this.servicetype, this.category);

  _SalonListCategory createState ()=> _SalonListCategory(seattype,servicetype,category);
}

class _SalonListCategory extends State<SalonListCategory>
{
  Future<bool> _onWillPop() async{

    print(";negnreogjeg $seattype");
  ...
  Widget getServiceListContainer(salondata){
      ...
      child: StreamBuilder(
        stream: FirebaseFirestore.instance.collection("services").doc(salondata['vendorid']).collection("service").snapshots(),
  ...
  Widget getServiceContainer(salondata,servicedata,call,data)
  {
    ...
    return GestureDetector(
      onTap: (){
        call(seattype,servicetype,category,salondata['vendorid'],servicedata['serviceid']);
      },
      child: Container(
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Row(
                        children: [
                          ...
                          Text("S ",
                            style: TextStyle(
                                color: salondata['businessTiming'][6]['6']['activate'] == 0 ? getBlackMate() : getMateGold(),
                                fontFamily: "ubuntum",
                                fontSize: 15
                            ),
                          ),
                          Text(" M ",
                            style: TextStyle(
                                color: salondata['businessTiming'][0]['0']['activate'] == 0 ? getBlackMate() : getMateGold(),
                                fontFamily: "ubuntum",
                                fontSize: 15
                            ),
                          ),
                          ...
                          Text(" T ",
                            style: TextStyle(
                                color: salondata['businessTiming'][1]['1']['activate'] == 0 ? getBlackMate() : getMateGold(),
                                fontFamily: "ubuntum",
                                fontSize: 15
                            ),
                          ),
                          ...
                          Text(" W ",
                            style: TextStyle(
                                color: salondata['businessTiming'][2]['2']['activate'] == 0 ? getBlackMate() : getMateGold(),
                                fontFamily: "ubuntum",
                                fontSize: 15
                            ),
                          ),
                          ...
                          Text(" T ",
                            style: TextStyle(
                                color: salondata['businessTiming'][3]['3']['activate'] == 0 ? getBlackMate() : getMateGold(),
                                fontFamily: "ubuntum",
                                fontSize: 15
                            ),
                          ),
                          ...
                          Text(" F ",
                            style: TextStyle(
                                color: salondata['businessTiming'][4]['4']['activate'] == 0 ? getBlackMate() : getMateGold(),
                                fontFamily: "ubuntum",
                                fontSize: 15
                            ),
                          ),
                          ...
                          Text(" S ",
                            style: TextStyle(
                                color: salondata['businessTiming'][5]['5']['activate'] == 0 ? getBlackMate() : getMateGold(),
                                fontFamily: "ubuntum",
                                fontSize: 15
                            ),
                          ),
  ...
  _SalonListCategory(this.seattype, this.servicetype, this.category);
