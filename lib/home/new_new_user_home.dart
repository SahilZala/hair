...
import 'package:hair/checkout/cart_preview.dart';
...
import 'package:hair/home/complete_order.dart';
import 'package:hair/home/groom_bridal_salon.dart';
import 'package:hair/home/my_order_in_cancel.dart';
...
import 'package:hair/home/user_notification.dart';
    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text("Hair app",style: TextStyle(color: getMateGold(),fontSize: 20,fontFamily: "ubuntum"),),
          //  // ],
          leading: Container(
            margin: EdgeInsets.all(5),
            decoration: BoxDecoration(
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    decoration: BoxDecoration(
                      color: getBlackMate(),
                      borderRadius: BorderRadius.only(bottomLeft: Radius.circular(0),bottomRight: Radius.circular(340))
                    ),
                    child: Column(
                  ...
                  //       .size
                  //       .width,
                  //   child: Text("Package service",textScaleFactor: 0.9,style: TextStyle(color: getBlackMate(),fontSize: 22,fontFamily: "ubuntub"),),
                  // ),
                  //
                  // getPackageSalon(),
                  //
  ...
  Widget getFunctionPanel(String imageurl,salonname)
  {
    return GestureDetector(
      onTap: (){
        ...
        //push replacement added
        salonname == "Groom salon" ?
        Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => GroomBridalListing("groom","salon"))) :
        Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => GroomBridalListing("bridal","salon")));
      },
      child: Stack(
        children: [
          Container(
...
//                       }
  ...
  Widget getPackageWidget(Map? data,Map? packagedata)
  {
    print(data);
    return GestureDetector(
      onTap: (){
    ...
    return Container(
      ...
      child: Wrap(
        ...
        children: [
          ...
          getHorizontalItem("images/newhaircolor.png", "hair color",(){Navigator.pushReplacement(
              context,
          ...
          // }),
          // getHorizontalItem("images/razor.png", "shaving",(){Navigator.pushReplacement(
          //     context,
          //     MaterialPageRoute(builder: (context) => SalonListCategory()));
          // }),
    ...
    return SafeArea(
      child: Scaffold(
          ...
          appBar: AppBar(
            ...
            title: Text("My Profile",style: TextStyle(color: getMateGold(),fontSize: 20,fontFamily: "ubuntum"),),
                              ...
                              SingleChildScrollView(
                                ...
                                child: Row(
                                  children: snapshot.data!.docs.map((e) {
                                    ...
                                    Map? salondata = e.data();
                                    print("AAAAAAA ${salondata}");

                                  //  return Container();
                                    return Container(
                                        child: StreamBuilder(
                                          stream: getPackageData(
                                              salondata!['vendorid']),
                                          builder: (BuildContext context, AsyncSnapshot<QuerySnapshot<Map<dynamic, dynamic>>> snapshot) {
                                            if(snapshot.hasData)
                                            {
                                                if(snapshot.data != null){
                                                  return Row(
                                                    children:  snapshot.data!.docs.map((e){
                                                      Map package = e.data();
                                                      return getPackageWidget(salondata,package);
                                                    }).toList(),
                                                  );
                                                }
                                                else{
  ...
  Widget buildFloatingSearchBar() {
    ...
    return FloatingSearchBar(
      ...
      border: BorderSide(color: getMateGold()),
      ...
      actions: [
        FloatingSearchBarAction(
          ...
          child: IconButton(
            ...
            icon: Icon(CupertinoIcons.slider_horizontal_3,color: getMateGold(),),
            onPressed: () {
                Navigator.pushReplacement(
                    context,
        ...
        if(snapshot.hasData)
        {
          if(snapshot.data != null)
          {
            ...
            snapshot.data?.docs.forEach((element) {
              print("nonnononononononnoononono ${element.data()}");
            });
            ...
            return SingleChildScrollView(
              ...
              child: Column(
                children: snapshot.data!.docs.map((e){
                  return getOrderList(e.data()['key']);
                  //return Text("${e.data()['key']}");
                }).toList(),
              ),
            );
            return Container();
          ...
          if(snapshot.data != null)
          {
            ...
            if(mainData?.length != 0) {
              ...
              return SingleChildScrollView(
                ...
                child: Column(
                  children: actualData.map((e) {
                    return getCompletedListContainer(e,e['vendorid'],"queue");
                  }).toList(),
                ),
              );
  ...
  Widget getOrderList(String vendorid)
  {
    return StreamBuilder(
        ...
        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot<Map<String, dynamic>>> snapshot)
        {
          if(snapshot.hasData)
          {
            if(snapshot.data!.docs != null) {
              ...
              print("sasas ${snapshot.data!.docs}");
              return SingleChildScrollView(
                physics: BouncingScrollPhysics(),
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  mainAxisAlignment: MainAxisAlignment.start,
                  children: snapshot.data!.docs.map((e){
                    return getCompletedListContainer(e.data(),vendorid,"queue");
                  }).toList(),
                ),
              );
            }
  ...
  Widget getCompletedListContainer(Map orderdata,String vendorid,String comes)
  {
    
    return StreamBuilder(
      stream: FirebaseFirestore.instance.collection("business").doc(vendorid).snapshots(),
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          "${DateFormat("HH : mm").parse(orderdata['starttime'].toString()).hour} : "
                              "${DateFormat("HH : mm").parse(orderdata['starttime'].toString()).minute == 0 ? "00" : DateFormat("HH : mm").parse(orderdata['starttime'].toString()).minute}",
                          style: TextStyle(
                              color: getGrey(),
                              fontFamily: "ubuntur"
                          ),
                          ...
                          onTap: () {
                            ...
                            print(slotMap);
                              ...
                              FirebaseAuth.instance.currentUser!.uid,
                                ...
                                oc.orderid = orderdata['orderid'];

                                oc.disount = orderdata['discount'];
                                oc.finaltotal = orderdata['finaltotal'];
                                oc.total = orderdata['total'];
                                oc.tax = orderdata['tax'];
                            ...
                            oc.paymentstatus = orderdata['paymentstatus'];
                            oc.serviceplace = orderdata['serviceplace'];
                            oc.lat = orderdata['lat'];
                            oc.log = orderdata['log'];

                            oc.seattype = orderdata['seattype'];
  ...
  Widget getCompletedQueue()
  {
    return StreamBuilder(
      stream: FirebaseFirestore.instance.collection("users")
          ...
          .collection("myorder")
          .where("paymentstatus",isEqualTo: "complete")
          .where("servicestatus",isEqualTo: "complete") // after completion
          .snapshots(),
      builder: (BuildContext context, AsyncSnapshot<QuerySnapshot<Map<String, dynamic>>> snapshot) {
          ...
          if(snapshot.data != null)
          {
            ...
            if(mainData?.length != 0) {
              ...
              return SingleChildScrollView(
                ...
                child: Column(
                  children: actualData.map((e) {
                    return getCompletedListContainer(e,e['vendorid'],"complete");
                  }).toList(),
                ),
              );
  ...
  Widget getCancelQueue()
  {
    return StreamBuilder(
      stream: FirebaseFirestore.instance.collection("users")
          ...
          .collection("myorder")
          //.where("paymentstatus",isEqualTo: "complete")
          .where("servicestatus",isEqualTo: "cancel") // after cancelation
          .snapshots(),
      builder: (BuildContext context, AsyncSnapshot<QuerySnapshot<Map<String, dynamic>>> snapshot) {
          ...
          if(snapshot.data != null)
          {
            ...
            if(mainData?.length != 0) {
              ...
              return SingleChildScrollView(
                ...
                child: Column(
                  children: actualData.map((e) {
                    return getCompletedListContainer(e,e['vendorid'],"cancel");
                  }).toList(),
                ),
              );
      ...
      body: SingleChildScrollView(
        physics: BouncingScrollPhysics(),
          ...
          children: [
            ...
            StreamBuilder(
              stream: Cart.non().getCart(FirebaseAuth.instance.currentUser!.uid),
              builder: (BuildContext context, AsyncSnapshot<QuerySnapshot<Map<String, dynamic>>> snapshot) {
                if(snapshot.hasData)
                {
                  if(snapshot.data !=null)
                    ...
                    return SingleChildScrollView(
                      ...
                      child: Column(
                        children: snapshot.data!.docs.map((e){
                          ...
                          return getProductListTiles(cartdata);
                        }).toList(),
                      ),
                    );
                  }
...
//            getProductListTiles(),
  ...
  Widget getProductListTiles(Map cartdata){
    return StreamBuilder(
      stream: FirebaseFirestore.instance
          .collection("business")
          .doc(cartdata['salonid'])
          .snapshots(),
      builder: (BuildContext context1, AsyncSnapshot<DocumentSnapshot<Map<String, dynamic>>> snapshot) {


        if(snapshot.hasData){
          if(snapshot.data != null) {

            //Map salondata = snapshot.data.data();

            print(cartdata['salonid']);
            return GestureDetector(
              onTap: (){
                showDialog(context: context1, builder: (_) => CupertinoAlertDialog(
                  ...
                  actions: [
                    CupertinoDialogAction(
                      onPressed: (){
                       ...
                       List val = cartdata['serviceid'];
                       List<String> servicelist = [];
                       val.forEach((element) {
                         servicelist.add(element);
                       });
                        //print(cartdata['serviceid']);

                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(builder: (context) =>
                                CartPreview(cartdata,servicelist)));

                        // Navigator.pushReplacement(
                        //     context,
                        //     MaterialPageRoute(builder: (context) =>
                        //         SalonCheckOut(cartdata['servicetype'],cartdata['gender'],cartdata['salonid'],
                        //             servicelist)));
                      },
                      child: Text("view"),
                      textStyle: TextStyle(
                    ...
                    CupertinoDialogAction(
                      onPressed: (){
                        Navigator.pop(context);
                        FirebaseFirestore.instance.collection("cart").doc(cartdata['vendorid'])
                            .collection("cart").doc(cartdata['salonid']).delete()
                            .whenComplete(() {
                          showTopSnackBar(
                              context,
              ...
              child: Container(
                ...
                child: ListTile(
                  ...
                  leading: CircleAvatar(
                    backgroundColor: Colors.white,
                    child: Text(
                      "${snapshot.data!.data()!['businessName'][0]}",
                      textScaleFactor: 0.9,
                      style: TextStyle(
                        color: getBlackMate(),
                        fontFamily: "ubuntub",
