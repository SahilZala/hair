...
class PackageSelection extends StatefulWidget
{
  ...
  PackageSelection(this.userid, this.businessid);

  _PackageSelection createState ()=> _PackageSelection(userid,businessid);
}
...
class _PackageSelection extends State<PackageSelection>
{
  ...
  String userid,businessid;
  _PackageSelection(this.userid, this.businessid);
