...
class _TimeDateSelection extends State<TimeDateSelection> {
  ...
  Future<bool> _onWillPop() async{
    ...
    Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => ServiceSelection(seattype,servicetype,servicecategory,salonid,serviceid,comes)));
    return false;
  }
          ...
          child: RaisedButton(
            ...
            onPressed: () {
              ...
              if(e.status == 0) {
                ...
                if((selectSlot.length*10) != int.parse(_servicedata['serviceduration']))
                {
                  if (selectSlot.isNotEmpty) {
              ...
              Radio(
                ...
                onChanged: (value) {
                  setState(() {
                    ...
                    _seatcount = int.parse(_businessdetail['hairMaleSeats']);
              ...
              Radio(
                ...
                onChanged: (value) {
                  setState(() {
                    ...
                    _seatcount = int.parse(_businessdetail['hairFemaleSeats']);
...
//        print(endTimeIteration.hour);
  ...
  void bookSlots(userid, vendorid, serviceid, seattype, selecteddate, seatnumber, gender, starttime, endtime, servicestatus, totalduration, slotcount, data)
  {
    ...
    Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => OrderPreview(oc,"single",comes)));
  }
...
class NewSlots
{
  ...
  int status;
  int seatcount = 0;
  NewSlots(this.start, this.status);
}