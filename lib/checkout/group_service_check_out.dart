...
class SalonCheckOut extends StatefulWidget{
  ...
  SalonCheckOut(this.servicetype, this.gender, this.salonid, this.serviceid,this.comes);

  _SalonCheckOut createState ()=> _SalonCheckOut(
      this.servicetype, this.gender, this.salonid, this.serviceid,this.comes);
}

class _SalonCheckOut extends State<SalonCheckOut>
{
  Future<bool> _onWillPop() async{
    ...
    if(comes == "cpp")
    {
      ...
      Navigator.pushReplacement(context, MaterialPageRoute(
          builder: (context) => SalonDetails(salonid)));
    }
    return false;
  }
...
//        print(endTimeIteration.hour);
  ...
  void bookSlots(userid, vendorid, serviceid, seattype, selecteddate, seatnumber, gender, starttime, endtime, servicestatus, totalduration, slotcount, data)
  {
    ...
    Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => OrderPreview(oc,"multi","gsco")));
  ...
  void rectifySlots(String businessid,String date,String gender){
    ...
    obj.checkOrderDataNew(businessid, date, gender,servicetype).then((value){
  ...
  _SalonCheckOut(this.servicetype, this.gender, this.salonid, this.serviceid,this.comes);
