...
class CartPreview extends StatefulWidget{
  ...
  _CartPreview createState ()=> _CartPreview(c,serviceid);

  CartPreview(this.c,this.serviceid);


}

class _CartPreview extends State<CartPreview>{
                          ...
                          onPressed: () async {
                            ...
                            Navigator.pushReplacement(
                                ...
                                MaterialPageRoute(builder: (context) =>
                                    SalonCheckOut(c['servicetype'],c['gender'],c['salonid'],
                                        serviceid,"cpp")));
                          },
                          child: Text(
                            "CONTINUE",
  ...
  Widget getServiceWidget(String serviceid)
  {
    return StreamBuilder(
      stream: FirebaseFirestore.instance.collection("services").doc(c['salonid']).collection("service").doc(serviceid).snapshots(),
  ...
  Widget getSalonData()
  {
    return Column(
      children: [
        ...
        StreamBuilder(
          stream: FirebaseFirestore.instance.collection("business").doc(c['salonid']).snapshots(),
          builder: (BuildContext context, AsyncSnapshot<DocumentSnapshot<Map<String, dynamic>>> snapshot) {
            if(snapshot.hasData)
            {
              if(snapshot.data != null)
  ...
  void getSalonInfo()
  {
    FirebaseFirestore.instance.collection("business").doc(c['salonid']).get().then((value){
      setState(() {
  ...
  Map c;
  List<String> serviceid;
  _CartPreview(this.c,this.serviceid);
}