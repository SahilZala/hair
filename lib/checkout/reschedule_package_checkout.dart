...
class PackageServiceReschedule extends StatefulWidget
{
  String packageid;
  String vendorid;
  ...
  PackageServiceReschedule(this.packageid, this.vendorid,this.oc);

  _PackageServiceReschedule createState()=> _PackageServiceReschedule(this.packageid, this.vendorid,this.oc);
}

class _PackageServiceReschedule extends State<PackageServiceReschedule>
{
...
//        print(endTimeIteration.hour);
  ...
  void bookSlots(userid, vendorid, serviceid, seattype, selecteddate, seatnumber, gender, starttime, endtime, servicestatus, totalduration, slotcount, data)
  {
    ...
    OrderClass newOc = OrderClass(userid, vendorid, servicedata, seattype, selecteddate, seatnumber, gender, starttime, endtime, servicestatus, totalduration, slotcount, data,la,lo,userAddress);
    newOc.servicetype = "package";


    newOc.paymentstatus = oc.paymentstatus;
    newOc.totalduration = oc.totalduration;
    newOc.total = oc.total;
    newOc.finaltotal = oc.finaltotal;
    newOc.disount = oc.disount;
    newOc.orderid = oc.orderid;


    print("dsdsd ${oc.paymentstatus}");

    Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => PackageRescheduleOrderPreview(newOc)));
  ...
  _PackageServiceReschedule(this.packageid, this.vendorid,this.oc);
